...
US_UNIVERSE = {
    ...
    "Consumer Cyclical": [
        ...
        "CMG","MCD","SBUX","YUM","QSR","DPZ","WEN","JACK",
    ],
    "Consumer Defensive": [
        "WMT","COST","KR","TGT","DG","DLTR","SYY","KO","PEP","MDLZ",
        "GIS","CPB","CAG","MKC","HRL","SJM","POST","LANC","CALM",
